...
Upgrade = {
	...
	packgeUrl: 'http://app.leanote.com/getUpgradePackage', // http://7xigkl.com1.z0.glb.clouddn.com/0.3.4.zip
	...
	upgrade: function(curVersion, ret) {
		...
		$progress.show();
		var url = "http://7xigkl.com1.z0.glb.clouddn.com/" + ret.nextVersion + ".zip";
